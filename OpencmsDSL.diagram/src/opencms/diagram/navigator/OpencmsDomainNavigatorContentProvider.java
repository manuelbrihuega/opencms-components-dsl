 ...
 * @generated
 */
public class OpencmsDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public OpencmsDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof OpencmsDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((OpencmsDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new OpencmsDomainNavigatorItem((EObject) objects[i],
