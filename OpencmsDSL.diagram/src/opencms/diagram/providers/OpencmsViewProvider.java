 ...
 * @generated
 */
public class OpencmsViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return DiagramaEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = OpencmsVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = OpencmsVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!OpencmsElementTypes.isKnownElementType(elementType)
		...
		return ComponenteEditPart.VISUAL_ID == visualID
				|| UrlEditPart.VISUAL_ID == visualID
				|| SelectorArchivosEditPart.VISUAL_ID == visualID
				|| TagEditPart.VISUAL_ID == visualID
				|| IdentificadorInternoEditPart.VISUAL_ID == visualID
				|| FechaEditPart.VISUAL_ID == visualID
				|| EntradillaEditPart.VISUAL_ID == visualID
				|| BotonSeleccionEditPart.VISUAL_ID == visualID
				|| EnlaceEditPart.VISUAL_ID == visualID
				|| VideoEditPart.VISUAL_ID == visualID
				|| TextoEditPart.VISUAL_ID == visualID
				|| BotonEditPart.VISUAL_ID == visualID
				|| TituloEditPart.VISUAL_ID == visualID
				|| EtiquetaEditPart.VISUAL_ID == visualID
				|| AudioEditPart.VISUAL_ID == visualID
				|| SubtituloEditPart.VISUAL_ID == visualID
				|| EntradaTextoEditPart.VISUAL_ID == visualID
				|| ImagenEditPart.VISUAL_ID == visualID
				|| BanerEditPart.VISUAL_ID == visualID
				|| IconoRedSocialEditPart.VISUAL_ID == visualID
				|| MenuDesplegableEditPart.VISUAL_ID == visualID
				|| BarraDesplegableEditPart.VISUAL_ID == visualID
				|| SliderEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = OpencmsVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != OpencmsVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(DiagramaEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = OpencmsVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = OpencmsVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ComponenteEditPart.VISUAL_ID:
			return createComponente_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case UrlEditPart.VISUAL_ID:
			return createUrl_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case SelectorArchivosEditPart.VISUAL_ID:
			return createSelectorArchivos_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case TagEditPart.VISUAL_ID:
			return createTag_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case IdentificadorInternoEditPart.VISUAL_ID:
			return createIdentificadorInterno_3004(domainElement,
					containerView, index, persisted, preferencesHint);
		case FechaEditPart.VISUAL_ID:
			return createFecha_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case EntradillaEditPart.VISUAL_ID:
			return createEntradilla_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		case BotonSeleccionEditPart.VISUAL_ID:
			return createBotonSeleccion_3007(domainElement, containerView,
					index, persisted, preferencesHint);
		case EnlaceEditPart.VISUAL_ID:
			return createEnlace_3008(domainElement, containerView, index,
					persisted, preferencesHint);
		case VideoEditPart.VISUAL_ID:
			return createVideo_3009(domainElement, containerView, index,
					persisted, preferencesHint);
		case TextoEditPart.VISUAL_ID:
			return createTexto_3010(domainElement, containerView, index,
					persisted, preferencesHint);
		case BotonEditPart.VISUAL_ID:
			return createBoton_3011(domainElement, containerView, index,
					persisted, preferencesHint);
		case TituloEditPart.VISUAL_ID:
			return createTitulo_3012(domainElement, containerView, index,
					persisted, preferencesHint);
		case EtiquetaEditPart.VISUAL_ID:
			return createEtiqueta_3013(domainElement, containerView, index,
					persisted, preferencesHint);
		case AudioEditPart.VISUAL_ID:
			return createAudio_3014(domainElement, containerView, index,
					persisted, preferencesHint);
		case SubtituloEditPart.VISUAL_ID:
			return createSubtitulo_3015(domainElement, containerView, index,
					persisted, preferencesHint);
		case EntradaTextoEditPart.VISUAL_ID:
			return createEntradaTexto_3016(domainElement, containerView, index,
					persisted, preferencesHint);
		case ImagenEditPart.VISUAL_ID:
			return createImagen_3017(domainElement, containerView, index,
					persisted, preferencesHint);
		case BanerEditPart.VISUAL_ID:
			return createBaner_3018(domainElement, containerView, index,
					persisted, preferencesHint);
		case IconoRedSocialEditPart.VISUAL_ID:
			return createIconoRedSocial_3019(domainElement, containerView,
					index, persisted, preferencesHint);
		case MenuDesplegableEditPart.VISUAL_ID:
			return createMenuDesplegable_3020(domainElement, containerView,
					index, persisted, preferencesHint);
		case BarraDesplegableEditPart.VISUAL_ID:
			return createBarraDesplegable_3021(domainElement, containerView,
					index, persisted, preferencesHint);
		case SliderEditPart.VISUAL_ID:
			return createSlider_3022(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (OpencmsVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	 ...
	 * @generated
	 */
	public Node createComponente_2001(EObject domainElement,
		...
		node.setType(OpencmsVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createUrl_3001(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(UrlEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5001 = createLabel(node,
				OpencmsVisualIDRegistry.getType(UrlNameOrdenEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createSelectorArchivos_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createTag_3003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(TagEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5003 = createLabel(node,
				OpencmsVisualIDRegistry.getType(TagNameOrdenEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createIdentificadorInterno_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createFecha_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(FechaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEntradilla_3006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createBotonSeleccion_3007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createEnlace_3008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(EnlaceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createVideo_3009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(VideoEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createTexto_3010(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(TextoEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createBoton_3011(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(BotonEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createTitulo_3012(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(TituloEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5013 = createLabel(node,
				OpencmsVisualIDRegistry.getType(TituloEnlaceEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEtiqueta_3013(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry
				.getType(EtiquetaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createAudio_3014(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(AudioEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createSubtitulo_3015(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		Node label5017 = createLabel(node,
				OpencmsVisualIDRegistry
						.getType(SubtituloEnlaceEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEntradaTexto_3016(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createImagen_3017(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(ImagenEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5020 = createLabel(node,
				OpencmsVisualIDRegistry.getType(ImagenAltoEditPart.VISUAL_ID));
		Node label5021 = createLabel(node,
				OpencmsVisualIDRegistry.getType(ImagenAnchoEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createBaner_3018(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(BanerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createIconoRedSocial_3019(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createMenuDesplegable_3020(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createBarraDesplegable_3021(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createSlider_3022(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpencmsVisualIDRegistry.getType(SliderEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
