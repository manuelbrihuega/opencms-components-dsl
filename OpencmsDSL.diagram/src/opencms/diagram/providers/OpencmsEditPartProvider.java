...
import opencms.diagram.edit.parts.OpencmsEditPartFactory;
 ...
 * @generated
 */
public class OpencmsEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public OpencmsEditPartProvider() {
		setFactory(new OpencmsEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!DiagramaEditPart.MODEL_ID.equals(OpencmsVisualIDRegistry
					.getModelID(view))) {
				return false;
			}
