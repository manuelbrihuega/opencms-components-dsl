...
import opencms.diagram.edit.policies.OpencmsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class IdentificadorInternoNameOrdenEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IdentificadorInternoNameOrdenEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new OpencmsTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new DiagramaEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return OpencmsElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpencmsParserProvider
					.getParser(
							OpencmsElementTypes.IdentificadorInterno_3004,
							getParserElement(),
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.IdentificadorInternoNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					OpencmsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
