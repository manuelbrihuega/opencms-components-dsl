 ...
 * @generated
 */
public class UrlNameOrdenEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UrlNameOrdenEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpencmsParserProvider
					.getParser(
							OpencmsElementTypes.Url_3001,
							getParserElement(),
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.UrlNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
