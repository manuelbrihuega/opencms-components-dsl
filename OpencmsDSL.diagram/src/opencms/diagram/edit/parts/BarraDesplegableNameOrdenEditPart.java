 ...
 * @generated
 */
public class BarraDesplegableNameOrdenEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BarraDesplegableNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.BarraDesplegableNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
