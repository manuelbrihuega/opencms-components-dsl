 ...
 * @generated
 */
public class EnlaceNameOrdenEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EnlaceNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.EnlaceNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
