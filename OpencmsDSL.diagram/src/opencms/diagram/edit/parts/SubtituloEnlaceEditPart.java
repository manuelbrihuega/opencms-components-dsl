 ...
 * @generated
 */
public class SubtituloEnlaceEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SubtituloEnlaceEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.SubtituloEnlaceEditPart.VISUAL_ID));
		}
		return parser;
	}
