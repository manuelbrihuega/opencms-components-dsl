 ...
 * @generated
 */
public class MenuDesplegableNameOrdenEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MenuDesplegableNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.MenuDesplegableNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
