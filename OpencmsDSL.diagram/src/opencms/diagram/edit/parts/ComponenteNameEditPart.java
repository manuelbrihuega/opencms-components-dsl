 ...
 * @generated
 */
public class ComponenteNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponenteNameEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.ComponenteNameEditPart.VISUAL_ID));
		}
		return parser;
	}
