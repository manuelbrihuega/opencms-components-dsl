 ...
 * @generated
 */
public class TagNameOrdenEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TagNameOrdenEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpencmsParserProvider
					.getParser(
							OpencmsElementTypes.Tag_3003,
							getParserElement(),
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.TagNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
