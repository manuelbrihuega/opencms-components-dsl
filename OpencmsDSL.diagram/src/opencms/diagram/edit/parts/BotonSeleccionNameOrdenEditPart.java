 ...
 * @generated
 */
public class BotonSeleccionNameOrdenEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BotonSeleccionNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.BotonSeleccionNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
