 ...
 * @generated
 */
public class SubtituloNameOrdenEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SubtituloNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.SubtituloNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
