 ...
 * @generated
 */
public class EtiquetaNameOrdenEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EtiquetaNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.EtiquetaNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
