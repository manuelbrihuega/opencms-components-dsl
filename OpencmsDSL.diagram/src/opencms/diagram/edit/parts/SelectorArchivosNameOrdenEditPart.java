 ...
 * @generated
 */
public class SelectorArchivosNameOrdenEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SelectorArchivosNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.SelectorArchivosNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
