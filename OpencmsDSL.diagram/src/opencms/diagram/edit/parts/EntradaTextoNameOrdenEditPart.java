 ...
 * @generated
 */
public class EntradaTextoNameOrdenEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EntradaTextoNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.EntradaTextoNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
