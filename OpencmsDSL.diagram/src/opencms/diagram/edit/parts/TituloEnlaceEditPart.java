 ...
 * @generated
 */
public class TituloEnlaceEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TituloEnlaceEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.TituloEnlaceEditPart.VISUAL_ID));
		}
		return parser;
	}
