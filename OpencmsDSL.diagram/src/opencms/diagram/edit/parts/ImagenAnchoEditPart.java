 ...
 * @generated
 */
public class ImagenAnchoEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ImagenAnchoEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.ImagenAnchoEditPart.VISUAL_ID));
		}
		return parser;
	}
