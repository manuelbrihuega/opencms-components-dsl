...
import opencms.diagram.edit.commands.OpencmsCreateShortcutDecorationsCommand;
import opencms.diagram.edit.policies.DiagramaCanonicalEditPolicy;
import opencms.diagram.edit.policies.DiagramaItemSemanticEditPolicy;
...
public class DiagramaEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Opencms"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DiagramaItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DiagramaCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new OpencmsCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
