 ...
 * @generated
 */
public class EntradillaNameOrdenEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntradillaNameOrdenEditPart(View view) {
		super(view);
	}
			...
			parser = OpencmsParserProvider
					.getParser(
							...
							OpencmsVisualIDRegistry
									.getType(opencms.diagram.edit.parts.EntradillaNameOrdenEditPart.VISUAL_ID));
		}
		return parser;
	}
