...
import opencms.diagram.part.OpencmsDiagramUpdater;
import opencms.diagram.part.OpencmsNodeDescriptor;
 ...
 * @generated
 */
public class ComponenteComponenteElementoVisualCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return OpencmsPackage.eINSTANCE.getComponente_ElementoVisual();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<OpencmsNodeDescriptor> childDescriptors = OpencmsDiagramUpdater
				.getComponenteComponenteElementoVisualCompartment_7002SemanticChildren(viewObject);
		for (OpencmsNodeDescriptor d : childDescriptors) {
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = OpencmsVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	protected void refreshSemantic() {
		...
		List<OpencmsNodeDescriptor> childDescriptors = OpencmsDiagramUpdater
				.getComponenteComponenteElementoVisualCompartment_7002SemanticChildren((View) getHost()
						.getModel());
		...
		for (Iterator<OpencmsNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			OpencmsNodeDescriptor next = descriptorsIterator.next();
			String hint = OpencmsVisualIDRegistry.getType(next.getVisualID());
		...
		for (OpencmsNodeDescriptor next : childDescriptors) {
			String hint = OpencmsVisualIDRegistry.getType(next.getVisualID());
