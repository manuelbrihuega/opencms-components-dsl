 ...
 * @generated
 */
public class ComponenteItemSemanticEditPolicy extends
		OpencmsBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ComponenteItemSemanticEditPolicy() {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (OpencmsVisualIDRegistry.getVisualID(node)) {
			case ComponenteComponenteElementoOcultoCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (OpencmsVisualIDRegistry.getVisualID(cnode)) {
