 ...
 * @generated
 */
public class OpencmsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public OpencmsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.OpencmsElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "opencms".equals(fileExtension); //$NON-NLS-1$
	}
